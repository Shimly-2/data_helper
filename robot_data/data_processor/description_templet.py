...
@DATA_PROCESSER_REGISTRY.register("DescriptionTmp")
class DescriptionTmp(BaseDataProcessor):
    """decription correct"""
    def __init__(
        self,
        workspace,
        ...
        for idx in tqdm(meta_info["frame_info"], colour='green', desc=f'PID[{os.getpid()}]'):
            if "Move" in meta_info["frame_info"][idx]["instruction"]:
                ...
                try:
                    ...
                    meta_info["frame_info"][idx]["label"] = labels["Move"][object_name]
                    meta_info["frame_info"][idx]["action"] = "grasp"
                    meta_info["frame_info"][idx]["contact_state"] = "contact"
                except:
                    print("Missing key:", object_name)
                ...
                try:
                    ...
                    meta_info["frame_info"][idx]["label"] = labels["Move"][object_name]
                    meta_info["frame_info"][idx]["action"] = "lift"
                    meta_info["frame_info"][idx]["contact_state"] = "contact"
                except:
                    print("Missing key:", object_name)
