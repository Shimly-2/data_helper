...
for i in range(len(algos)):
    ...
    # 画图
    ax = sns.tsplot(time=x_data[:500], data=y_data[0][:500], color=current_palette[i], linestyle=linestyle[0], condition=algos[i])
    ...
    # 设置x,y标题以及x、y两轴范围
    ax.set(xlabel="Steps", ylabel='Force Return', xlim=[0, 500], ylim=[0, 0.3])
